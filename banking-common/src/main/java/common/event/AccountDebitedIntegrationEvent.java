...
@Getter
public class AccountDebitedIntegrationEvent extends BaseIntegrationEvent {
    ...
    public AccountDebitedIntegrationEvent(UUID creditedAccountId, UUID debitedAccountId,
    ...
    @JsonCreator
    public AccountDebitedIntegrationEvent(
