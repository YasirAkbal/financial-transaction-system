...
@Getter
public class AccountCreditFailedIntegrationEvent extends BaseIntegrationEvent {
    ...
    public AccountCreditFailedIntegrationEvent(String correlationId, UUID transactionId, UUID sourceAccountId, UUID targetAccountId,
    ...
    @JsonCreator
    public AccountCreditFailedIntegrationEvent(
